...
analysis of bottom trawl samples sequenced on April 6th MiSeq run  - used less stringent filter and merging parameters... 
...
```{r}
seqs <- read.csv("/genetics/edna/workdir/bottomtrawl_2022/20230406/trimmed/filtered2/outputs/seqtab.csv", row.names = 1)
```
...
write.csv(my_class, "/genetics/edna/workdir/bottomtrawl_2022/20230406/trimmed/filtered2/outputs/asv_taxonomy_insect.csv")
```
...
```{r}
write.csv(my_class_short, "/genetics/edna/workdir/bottomtrawl_2022/20230406/trimmed/filtered2/outputs/taxon_table.csv")
```
