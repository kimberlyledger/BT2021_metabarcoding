---
title: "blastn taxonomic analysis - mifish 20230216"
author: "Kimberly Ledger"
date: "2023-02-27"
output: html_document
---

taxonomic id of some 2021 bottom trawl samples using MiFish primers  
the 20230216 run was the regular v2 300 cycle MiSeq cartridge 
...
taxonomy <-read.delim("/genetics/edna/workdir/bottomtrawl_2022/20230216/trimmed/filtered/outputs/blastn_taxlineage.txt", header = FALSE, na.strings=c(""," ","NA"))
...
there are 60 identifiable ASV's. how does this compare to other MiFish libraries the lab has processed? 
...
only hybrid seq is O.mykiss and Salmo salar... will just remove these ID's since other Oncorhynchus ID's are present for the same ASV's
```{r}
taxon_df <- taxon_df %>%
...
sorted_tax_df <- bind_rows(single_family, single_genus, single_spp)
```
...
```{r}
write.csv(collapsed_taxonomy, "/genetics/edna/workdir/bottomtrawl_2022/20230216/trimmed/filtered/outputs/asv_taxonomy_blastn.csv")
```
