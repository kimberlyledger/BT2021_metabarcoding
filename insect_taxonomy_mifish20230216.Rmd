...
```{r}
seqs <- read.csv("/genetics/edna/workdir/bottomtrawl_2022/20230310/trimmed/filtered/outputs/seqtab.csv", row.names = 1)
```
...
write.csv(my_class, "/genetics/edna/workdir/bottomtrawl_2022/20230310/trimmed/filtered/outputs/asv_taxonomy_insect.csv")
```
...
```{r}
write.csv(my_class_short, "/genetics/edna/workdir/bottomtrawl_2022/20230310/trimmed/filtered/outputs/taxon_table.csv")
```
