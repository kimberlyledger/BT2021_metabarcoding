...
```{r}
taxons_insect <- read.csv("/genetics/edna/workdir/bottomtrawl_2022/20230406/trimmed/filtered/outputs/asv_taxonomy_insect.csv", row.names = 1) %>%
...
```{r}
asv_table <- read.csv("/genetics/edna/workdir/bottomtrawl_2022/20230406/trimmed/filtered/outputs/ASVtable.csv") %>%
  rename(SampleID = X)
```
